...
_DEVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shader_compiler', full_name='gfauto.Device.shader_compiler', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='binaries', full_name='gfauto.Device.binaries', index=6,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ignored_crash_signatures', full_name='gfauto.Device.ignored_crash_signatures', index=8,
...
_DEVICEHOST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='custom_launcher', full_name='gfauto.DeviceHost.custom_launcher', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEVICESHADERCOMPILER = _descriptor.Descriptor(
  name='DeviceShaderCompiler',
  full_name='gfauto.DeviceShaderCompiler',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='binary', full_name='gfauto.DeviceShaderCompiler.binary', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='args', full_name='gfauto.DeviceShaderCompiler.args', index=1,
...
_DEVICE.fields_by_name['shader_compiler'].message_type = _DEVICESHADERCOMPILER
...
_DEVICE.oneofs_by_name['device'].fields.append(
  _DEVICE.fields_by_name['shader_compiler'])
_DEVICE.fields_by_name['shader_compiler'].containing_oneof = _DEVICE.oneofs_by_name['device']
...
DESCRIPTOR.message_types_by_name['DeviceShaderCompiler'] = _DEVICESHADERCOMPILER
...
DeviceShaderCompiler = _reflection.GeneratedProtocolMessageType('DeviceShaderCompiler', (_message.Message,), {
  'DESCRIPTOR' : _DEVICESHADERCOMPILER,
  '__module__' : 'gfauto.device_pb2'
  # @@protoc_insertion_point(class_scope:gfauto.DeviceShaderCompiler)
  })
_sym_db.RegisterMessage(DeviceShaderCompiler)
