...
class Settings(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"custom_binaries",u"device_list",u"maximum_duplicate_crashes",u"maximum_fuzz_failures"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"device_list",b"device_list"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"custom_binaries",b"custom_binaries",u"device_list",b"device_list",u"maximum_duplicate_crashes",b"maximum_duplicate_crashes",u"maximum_fuzz_failures",b"maximum_fuzz_failures"]) -> None: ...
