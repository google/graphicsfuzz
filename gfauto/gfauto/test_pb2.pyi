...
class Test(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"binaries",u"crash_regex_override",u"crash_signature",u"device",u"expected_status",u"glsl",u"spirv_fuzz",u"test"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"binaries",b"binaries",u"crash_regex_override",b"crash_regex_override",u"crash_signature",b"crash_signature",u"device",b"device",u"expected_status",b"expected_status",u"glsl",b"glsl",u"spirv_fuzz",b"spirv_fuzz",u"test",b"test"]) -> None: ...
