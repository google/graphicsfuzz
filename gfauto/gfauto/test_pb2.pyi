...
class Test(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"binaries",u"crash_regex_override",u"crash_signature",u"derived_from",u"device",u"expected_status",u"glsl",u"skip_validation",u"spirv_fuzz",u"test"]) -> None: ...
    else:
