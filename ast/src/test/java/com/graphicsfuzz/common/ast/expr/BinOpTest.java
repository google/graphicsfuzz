...
public class BinOpTest {
  ...
  private String getOpTesterProgram(boolean p) {
    return "void main() {"
        + "  int a " + choose(p, BinOp.ASSIGN.getText(), "=") + "1, b "
            + choose(p, BinOp.ASSIGN.getText(), "=") + "2;"
        + "  bool x " + choose(p, BinOp.ASSIGN.getText(), "=") + " true, y "
            + choose(p, BinOp.ASSIGN.getText(), "=") + " false;"
        + "  "
        + "  a = 3" + choose(p, BinOp.COMMA.getText(), ",") + " 4;"
        + "  a = b " + choose(p, choose(p, BinOp.MOD.getText(), "X") + " a "
            + BinOp.MUL.getText(), "X") + " a;"
        + "  a = b " + choose(p, BinOp.DIV.getText(), "/") + " 2 "
            + choose(p, BinOp.ADD.getText(), "X") + " b "
            + choose(p, BinOp.SUB.getText(), "-") + " 3;"
