...
public class ExpressionGenerator {
  ...
  /**
   * This method generates the expression performing the addition of two values which result is
  ...
  /**
   * This method retrieves value from the function facts hold by fact manager and returns the
  ...
  /**
   * This method retrieves value from the variable facts hold by fact manager and returns the
  ...
  /**
   * Generates a new variable representing the given value. Generator also randomly decide
   * whether new variable should be available at the local or global scope.
   *
   * @param value              the value that will be computed by the expression generated by
   *                           this method.
   * @param factManager        manager class holding the value and its associated expression that
   ...
   * A number and type of function arguments for the generated function are chosen randomly by
   * generator.
   *
   * @param value              the value that will be computed by the expression generated by
   *                           this method.
