...
public class KnownValueShaderGenerator {
  ...
  public static void mainHelper(String[] args) throws ArgumentParserException, IOException {
    ...
    final ShaderJob newShaderJob = new GlslShaderJob(Optional.empty(), pipelineInfo, tu);
    // We randomly choose some of the uniforms generated by the generator to be pruned.
    PruneUniforms.prune(newShaderJob, generator.nextInt(pipelineInfo.getNumUniforms()),
        Arrays.asList(Constants.GLF_UNIFORM));
