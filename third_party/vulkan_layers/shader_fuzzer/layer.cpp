...
namespace graphicsfuzz_shader_fuzzer {
    ...
    namespace wrapped {
        VKAPI_ATTR uint32_t VKAPI_CALL vkCreateShaderModule(VkDevice device, VkShaderModuleCreateInfo const* pCreateInfo, AllocationCallbacks pAllocator, VkShaderModule* pShaderModule) {
            ...
            return graphicsfuzz_shader_fuzzer::vkCreateShaderModule(fn, device, pCreateInfo, pAllocator, pShaderModule);
        }
    }
    namespace internal {
        namespace {
        ...
        static const VkLayerProperties global_layer_properties[] = { {
                "VK_LAYER_GRAPHICSFUZZ_shader_fuzzer",
        ...
        const char* pName) {
            ...
            return reinterpret_cast<PFN_vkVoidFunction>(graphicsfuzz_shader_fuzzer::wrapped::func);
...
extern "C" {
    #define LAYER_NAME "VK_LAYER_GRAPHICSFUZZ_shader_fuzzer"
    #define LAYER_NAME_FUNCTION(fn) VK_LAYER_GRAPHICSFUZZ_shader_fuzzer##fn
    ...
    LAYER_NAME_FUNCTION(GetDeviceProcAddr)(VkDevice dev, const char *funcName) {
        return graphicsfuzz_shader_fuzzer::internal::vkGetDeviceProcAddr(dev, funcName);
    }
    ...
    GetInstanceProcAddr)(VkInstance instance, const char *funcName) {
        return graphicsfuzz_shader_fuzzer::internal::vkGetInstanceProcAddr(instance, funcName);
    }
    ...
    vkEnumerateInstanceLayerProperties(uint32_t *pPropertyCount,
    VkLayerProperties *pProperties) {
        return graphicsfuzz_shader_fuzzer::internal::vkEnumerateInstanceLayerProperties(pPropertyCount,
        pProperties);
    }
    ...
    uint32_t *pPropertyCount,
    VkExtensionProperties *pProperties) {
        return graphicsfuzz_shader_fuzzer::internal::vkEnumerateInstanceExtensionProperties(
        pLayerName, pPropertyCount, pProperties);
    }
    VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkEnumerateDeviceLayerProperties(
    VkPhysicalDevice physicalDevice, uint32_t *pPropertyCount,
    VkLayerProperties *pProperties) {
        return graphicsfuzz_shader_fuzzer::internal::vkEnumerateDeviceLayerProperties(
    ...
    uint32_t *pPropertyCount,
    VkExtensionProperties *pProperties) {
        return graphicsfuzz_shader_fuzzer::internal::vkEnumerateDeviceExtensionProperties(
