...
layout(push_constant) uniform push_constants {
    layout(offset = 64) float redOffset; // offset = sizeof(mat4)
};
...
void main() {
    outColor = vec4(fragColor.r + redOffset, fragColor.g, fragColor.b, 1.0);
}
)";
...
int main() {
  ...
  try {
    ...
    VkPushConstantRange push_constant_range_vertex = {};
    push_constant_range_vertex.stageFlags = VK_SHADER_STAGE_VERTEX_BIT;
    push_constant_range_vertex.offset = 0;
    push_constant_range_vertex.size = sizeof(glm::mat4);

    VkPushConstantRange push_constant_range_fragment = {};
    push_constant_range_fragment.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
    push_constant_range_fragment.offset = sizeof(glm::mat4);
    push_constant_range_fragment.size = sizeof(float);

    VkPushConstantRange push_constant_ranges[] = {
        push_constant_range_vertex, push_constant_range_fragment
    };
    ...
    {
      // Push constant matrix data. Rotates 180 degrees.
      // clang-format off
      ...
      vkCmdPushConstants(commandBuffer, pipelineLayout,
                         VK_SHADER_STAGE_FRAGMENT_BIT, sizeof(glm::mat4), sizeof(float),
                         &redOffset);
    }
