...
struct Vertex {
  ...
  static VkVertexInputAttributeDescription getAttributeDescriptions() {
    ...
    attributeDescriptions.offset = static_cast<uint32_t>(offsetof(Vertex, pos));
...
struct VertOffset {
  ...
  static VkVertexInputBindingDescription getBindingDescription() {
    ...
    bindingDescription.stride = sizeof(VertOffset);
...
int main() {
  ...
  try {
    ...
    VkMemoryRequirements vertex_offset_buffer_memory_requirements;
    vkGetBufferMemoryRequirements(device, offset_buffer,
                                  &vertex_offset_buffer_memory_requirements);
    {
      VkMemoryAllocateInfo vkMemoryAllocateInfo = {};
      vkMemoryAllocateInfo.sType = VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO;
    ...
    }
    {
      ...
      VkMappedMemoryRange rangeToFlush = {};
      rangeToFlush.sType = VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE;
      rangeToFlush.memory = vertex_offset_buffer_memory;
      rangeToFlush.offset = 0;
      rangeToFlush.size = VK_WHOLE_SIZE;
      vkFlushMappedMemoryRanges(device, 1, &rangeToFlush);
