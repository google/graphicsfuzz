...
The developer documentation currently focuses on opening the various projects in
IntelliJ IDEA. It also contains a [Build from command
line](#build-from-command-line) section further down.
