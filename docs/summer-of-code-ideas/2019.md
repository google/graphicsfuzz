...
The Android Graphics Tools team rely on several test harness to run tests on
...
harnesses used by the team. The test harnesses comprise the
[GraphicsFuzz](https://github.com/google/graphicsfuzz) Vulkan worker,
[Amber](https://github.com/google/amber) and the
[GAPID](https://github.com/google/gapid) replayer. The project will improve
information logging of these test harness, to report relevant information to
