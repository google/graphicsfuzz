...
public class Main extends ApplicationAdapter {
  ...
  public static void checkForGlError() throws GlErrorException {
  ...
  private void renderCurrentShader(String name, Mesh mesh) throws GlErrorException {
  ...
  private void readPixels(ByteBuffer pixelBuffer) throws GlErrorException {
    pixelBuffer.limit(pixelBuffer.capacity());
    pixelBuffer.position(0);
